...
if($lastInsertId)
{
$msg="Message send. We will contact you shortly";
}
else 
{
...
{ ?>
          <ul>
            ...
            <li>
              ...
              <div class="contact_info_m"><a href="tel:01865-168856"><?php   echo htmlentities($result->EmailId); ?></a></div>
            </li>
            <li>
              <div class="icon_wrap"> <i class="fa fa-phone" aria-hidden="true"></i></div>
              <div class="contact_info_m"><a href="mailto:arifulsujan44@gmail.com"><?php   echo htmlentities($result->ContactNo); ?></a></div>
            </li>
          </ul>
        <?php }} ?>
        </div>
